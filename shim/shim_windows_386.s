...
DATA go2xp_table+324(SB)/4, $go2xp_s_SetErrorMode(SB)
DATA go2xp_table+328(SB)/4, $0
DATA go2xp_table+332(SB)/4, $go2xp_SetErrorMode(SB)
// kernel32.dll!TerminateProcess
DATA go2xp_table+336(SB)/4, $go2xp_s_kernel32_dll(SB)
DATA go2xp_table+340(SB)/4, $go2xp_s_TerminateProcess(SB)
DATA go2xp_table+344(SB)/4, $0
DATA go2xp_table+348(SB)/4, $go2xp_TerminateProcess(SB)
// kernel32.dll!GetQueuedCompletionStatus
DATA go2xp_table+352(SB)/4, $go2xp_s_kernel32_dll(SB)
DATA go2xp_table+356(SB)/4, $go2xp_s_GetQueuedCompletionStatus(SB)
DATA go2xp_table+360(SB)/4, $0
DATA go2xp_table+364(SB)/4, $go2xp_GetQueuedCompletionStatus(SB)
// kernel32.dll!CancelIo
DATA go2xp_table+368(SB)/4, $go2xp_s_kernel32_dll(SB)
DATA go2xp_table+372(SB)/4, $go2xp_s_CancelIo(SB)
DATA go2xp_table+376(SB)/4, $0
DATA go2xp_table+380(SB)/4, $go2xp_CancelIo(SB)
// kernel32.dll!GetSystemDirectoryW
DATA go2xp_table+384(SB)/4, $go2xp_s_kernel32_dll(SB)
DATA go2xp_table+388(SB)/4, $go2xp_s_GetSystemDirectoryW(SB)
DATA go2xp_table+392(SB)/4, $0
DATA go2xp_table+396(SB)/4, $go2xp_GetSystemDirectoryW(SB)
// kernel32.dll!SetLastError
DATA go2xp_table+400(SB)/4, $go2xp_s_kernel32_dll(SB)
DATA go2xp_table+404(SB)/4, $go2xp_s_SetLastError(SB)
DATA go2xp_table+408(SB)/4, $0
DATA go2xp_table+412(SB)/4, $go2xp_SetLastError(SB)
// advapi32.dll!SystemFunction036
DATA go2xp_table+416(SB)/4, $go2xp_s_advapi32_dll(SB)
DATA go2xp_table+420(SB)/4, $go2xp_s_SystemFunction036(SB)
DATA go2xp_table+424(SB)/4, $0
DATA go2xp_table+428(SB)/4, $go2xp_SystemFunction036(SB)
GLOBL go2xp_table(SB), NOPTR, $432
